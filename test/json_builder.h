...
public:
	...
	void addScanResults(const std::unique_ptr<Opswat::MDExtendedScanResult> &scanResult, bool lowVisibility = false);
	void addProcessInfo(const std::unique_ptr<Opswat::MDExtendedProcessInfo> &processInfo);
